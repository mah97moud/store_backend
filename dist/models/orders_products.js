        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get orders_products ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find orders_products with id = ".concat(orderId, " ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype.addProductInOrder = function (orderId, productId, productName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO orders_products(orderId,productsId,productName) VALUES($1,$2,$3) RETURNING *';
                        return [4 /*yield*/, database_1.client.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [orderId, productId, productName])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add product with id = ".concat(productId, " ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
