...
var saltRounds = process.env.SALET_ROUNDS;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users(firstName,lastName,userPassword,email) VALUES($1,$2,$3,$4) RETURNING *';
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable create user(".concat(u.firstName + u.lastName, " : ").concat(err_2, ")"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable to Find user With id = ($id) : ".concat(err_3, ")"));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable to delete user With id = ($id) : ".concat(err_4, ")"));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("unauthenticate user ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
