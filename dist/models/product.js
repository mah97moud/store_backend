        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find product with id = ".concat(id, " ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [p.productName, p.price, p.category])];
                    case 2:
                        result = _a.sent();
                        product = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add product = ".concat(p, " ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
