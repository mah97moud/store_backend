...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authenticate(user.email, user.password)];
            case 2:
                u = _a.sent();
...
var usersRoutes = function (app) {
    app.get('/users', verify_auth_token_1["default"], users);
    app.get('/user/:id', verify_auth_token_1["default"], show);
    app["delete"]('/user/:id', verify_auth_token_1["default"], destroy);
