    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_2 = _a.sent();
                res.status(400);
                res.json("".concat(err_2, " ").concat(o));
                return [3 /*break*/, 4];
...
var ordersRoutes = function (app) {
    app.get('/orders', verify_auth_token_1["default"], orders);
    app.get('/order/:userId', verify_auth_token_1["default"], show);
    app.post('/order/addOrder', verify_auth_token_1["default"], create);
};
